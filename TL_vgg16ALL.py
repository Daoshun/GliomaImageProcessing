...
train_features, train_labels = extarct_features(train_dir, 160)
validation_features, validation_labels = extarct_features(validation_dir, 50)
# test_features, test_labels = extarct_features(test_dir, 1000)

train_features = np.reshape(train_features, (160, 6 * 6 * 512))
validation_features = np.reshape(validation_features, (50, 6 * 6 * 512))
...
# model.save_weights('TL_vgg16T1C_FT1.h5')
